...
!function () {
  ...
  w = window, y = {
    ...
    fuzzy: !1,
    exclude: []
  }, O = t({ required: g = ["searchInput", "resultsContainer", "json"] }), z = function (t) {
    return 0 < O.validate(t).length && L("You must specify the following required options: " + g), y = v.merge(
      y,
      t), o.setOptions({
